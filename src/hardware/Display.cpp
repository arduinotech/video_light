...
#define LEFT_SIGNS_COUNT 10

// Делим экран на сегменты, длина правого блока (символы)
#define RIGHT_SIGNS_COUNT 6
...
void Display::shortTimeBacklight()
{
    _backlightOffTime = millis() + SHORT_BACKLIGHT_MILLIS;
}